...
func TestModelFilter(t *testing.T) {
	...
	applyUpdate(original, reflect.ValueOf(&Test{
		...
		TestCustom:     Set(map[string]*Custom{"something": {Something: "something"}}),
		TestCustomEnum: Set(CustomEnumExample),
	...
	passEqFilter := &Test{
		...
		TestCustom:     Eq(map[string]*Custom{"something": {Something: "something"}}),
		TestCustomEnum: Eq(CustomEnumExample),
